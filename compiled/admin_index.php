...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	<HEAD>
		...
		<SCRIPT type=text/javascript src="<?php echo $domain_resource; ?>/admin/common.js"></SCRIPT>
	</HEAD>
	<BODY style="MARGIN: 0px" scroll=no>
		<DIV id=append_parent></DIV>
		<TABLE id=frametable cellSpacing=0 cellPadding=0 width="100%" height="100%">
		  		<TR>
					<TD height=90 colSpan=2>
					  <DIV class=mainhd><A class=logo href="admin_index.php">Discuz! 
					  Administrator's Control Panel</A> 
					  <DIV id=frameuinfo class=uinfo>
					  <P>你好, 创始人 <EM><?php echo $_SESSION['username']; ?></EM> [<A 
					  href="admin_logout.php" target=_top>退出</A>]</P>
					  <P class=btnlink><A href="index.php" target=_blank>站点首页</A></P></DIV>
					  <DIV class=navbg></DIV>
					  <DIV class=nav style="margin-top:30px;">
						  <UL id=topmenu>
							<LI>
								<EM>
								<A hideFocus id=header_index onMouseOver="previewheader('index')" onmouseout=previewheader() onClick="toggleMenu('index', 'admin_main.php');doane(event);" href="admin_index.php">&nbsp;站点信息&nbsp;</A>
								</EM>
							</LI>
							<LI>
								<EM>
									<A hideFocus id=header_global onMouseOver="previewheader('global')" onmouseout=previewheader() onClick="toggleMenu('global', 'admin_member.php');doane(event);" href="admin_member.php">&nbsp;用户管理&nbsp;</A>
								</EM>
							</LI>
							<LI>
								<EM>
									<A hideFocus id=header_style onMouseOver="previewheader('style')" onmouseout=previewheader() onClick="toggleMenu('style', 'admin_category.php');doane(event);" href="admin_category.php">&nbsp;版块管理&nbsp;</A>
								</EM>
							</LI>
							<LI>
								<EM>
								<A hideFocus id=header_topic onMouseOver="previewheader('topic')" onmouseout=previewheader() onClick="toggleMenu('topic', 'admin_detail.php');doane(event);" href="admin_detail.php">&nbsp;帖子管理&nbsp;</A>
								</EM>
							</LI>
							</UL>
						  <DIV class=navbd></DIV>
					...
					<TD class=menutd vAlign=top width=160>
						<DIV id=leftmenu class=menu>
							<UL style="DISPLAY: none" id=menu_index>
								<LI>
									<A hideFocus href="admin_main.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>站点信息</A>
								</LI>
								<LI>
									<A hideFocus href="admin_link.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>友情链接</A>
								</LI>
							</UL>
							<UL style="DISPLAY: none" id=menu_global>
								<LI><A hideFocus href="admin_member.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>编辑用户</A></LI>
								<LI><A hideFocus href="admin_lock_ip.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>禁止IP</A></LI>
							</UL>
							<UL style="DISPLAY: none" id=menu_style>
								<LI><A hideFocus href="admin_category.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>管理版块</A></LI>
								<LI><A hideFocus href="admin_category_add.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>添加版块</A></LI>
							</UL>
							<UL style="DISPLAY: none" id=menu_topic>
								<LI><A hideFocus href="admin_detail.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>帖子管理</A></LI>
								<LI><A hideFocus href="admin_detail_del.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>帖子回收站</A></LI>
								<LI><A hideFocus href="admin_detail_hf.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>回帖管理</A></LI>
								<LI><A hideFocus href="admin_detail_hf_del.php" target=main><EM title=新窗口打开 onclick=menuNewwin(this)></EM>回帖回收站</A></LI>
							</UL>
						</DIV>
					</TD>
					<TD class=mask vAlign=top width="100%">
						<IFRAME style="OVERFLOW: visible" id=main height="100%" src="admin_main.php" frameBorder=0 width="100%" name=main scrolling=yes></IFRAME>
					</TD>
				</TR>
		</TABLE>
		<DIV style="DISPLAY: none" id=scrolllink>
			<SPAN onclick=menuScroll(1)><IMG src="<?php echo $domain_resource; ?>/admin/scrollu.gif"></SPAN><SPAN onclick=menuScroll(2)><IMG src="<?php echo $domain_resource; ?>/admin/scrolld.gif"></SPAN>
		</DIV>
		<DIV class=copyright>
			<P>Powered by <A href="" target=_blank><?php echo $web_btm; ?></A> V2</P>
			<P>© 2012, <A href="" target=_blank><?php echo $web_btm; ?> Inc.</A></P>
		</DIV>
		...
		<SCRIPT type=text/JavaScript>
			var cookiepre = 'uq9K_2132_', cookiedomain = '', cookiepath = '/';
			var headers = new Array('index','global','style','topic'), admincpfilename = '', menukey = '';
			...
			function toggleMenu(key, url) {
				...
				if(key == 'uc') {
					parent.main.location = $('header_uc').href;
				}
				setMenuScroll();
			}
