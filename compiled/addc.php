...
<div id="wp" class="wp">
	<div id="pt" class="bm cl">
			<div class="z"><a href="./" class="nvhm" title="<?php echo $title; ?>"><?php echo $title; ?></a><em>&raquo;</em><a href="index.php">论坛</a><em>&raquo;</em><a href="index.php?bigid=<?php echo $bigId; ?>"><?php echo $bigName; ?></a><em>&raquo;</em><a href="list.php?classid=<?php echo $smallId; ?>"><?php echo $smallName; ?></a><em>&raquo;</em>发表帖子</div>
	</div>
			...
			<div class="bm bw0 cl" id="editorbox">
				...
				<div id="postbox">
					...
					<div id="post_extra" class="ptm cl">
						...
						<label id="extra_price_b" class="a" onclick="showExtra('extra_price')"><span id="extra_price_chk">售价</span></label>
						</div>
					
						<div id="post_extra_c">
							<div id="extra_price_c" class="exfm cl">
							售价:<input type="text" id="price" name="price" class="px pxs" onblur="extraCheck(2)" value="0" /> 金钱<span class="xg1">(最高 30 )</span>
							</div>
						</div>
					</div>
